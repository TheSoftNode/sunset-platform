...
// //           <QuizBrowsePage />
// //         ) : (
// //           <div className="shadow-lg w-full max-w-md mx-auto my-4">
// //             <h1 className="text-bold text-white text-center mt-4 mb-2">
// //               Do you need help to select kits and plans?
// //             </h1>
// //             <div className="flex justify-center space-x-4 mb-3">
// //               <button
// //                 className="p-2 px-4 bg-green-600 text-sm font-bold text-white rounded-lg cursor-pointer"
// //                 onClick={toggleQuizPage}
// //               >
// //                 YES
// //               </button>
// //               <button
// //                 className="p-2 px-4 bg-red-500 text-sm font-bold text-white rounded-lg cursor-pointer"
...
// //         <QuizBrowsePage />
// //       ) : (
// //         <div className="bg-cyan-800 w-full flex flex-col items-center justify-center gap-y-10 h-[28rem] px-4">
// //           <p className="text-center text-2xl font-bold text-white prose">
// //             Let's start to select our Sunset kits or plans of your choice.
// //           </p>

// //           <button
// //             className="bg-pink-600 text-white w-full max-w-md p-3 font-bold text-xl rounded-lg mx-auto shadow-2xl transition ease-in-out delay-150 hover:-translate-y-2 hover:scale-110 hover:bg-indigo-500 duration-300 block"
...
//           <QuizBrowsePage />
//         ) : (
//           <div className=" relative shadow-lg w-full max-w-md mx-auto my-4 bg-cyan-800 rounded-lg">
//            <span
