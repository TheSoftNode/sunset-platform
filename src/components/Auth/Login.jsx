...
{
    return (
        <div className='min-h-screen flex items-start pt-16 justify-center bg-gradient-to-r from-gray-100 to-white'>
            <form className='bg-white shadow-lg  mx-auto w-full max-w-sm p-10 rounded-lg border border-transparent transition duration-300 transform hover:scale-105 hover:shadow-xl'>
